...
function App() {
  // Auto-detection: package automatically detects localhost vs production
  // No config needed! But you can override if needed:
  // const authConfig = { authServiceUrl: 'http://custom:9999' };
  const { user, loading, isAuthenticated, logout, login, error, authServiceUrl } = useTeamworkAuth();
